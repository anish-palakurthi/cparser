...
/**
 * Returns whether an entity is a CFI target.
 *
 * @param ent  the entity
 */
FIRM_API int get_entity_is_cfi_target(const ir_entity *ent);

/**
 * Sets whether an entity is a CFI target.
 *
 * @param ent           the entity
 * @param is_cfi_target non-zero if this entity is a CFI target
 */
FIRM_API void set_entity_is_cfi_target(ir_entity *ent, int is_cfi_target);
