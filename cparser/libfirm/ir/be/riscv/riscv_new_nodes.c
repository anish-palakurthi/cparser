...
{
    const riscv_jalr_attr_t *attr_a = (const riscv_jalr_attr_t*)get_irn_generic_attr_const(a);
    const riscv_jalr_attr_t *attr_b = (const riscv_jalr_attr_t*)get_irn_generic_attr_const(b);
    return attr_a->n_params == attr_b->n_params;
}
